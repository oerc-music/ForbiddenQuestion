...
export default class Burger extends Component {
  ...
  render () {
    return (
      <Menu>
        <a id="home" className="menu-item" onClick={this.props.Home}><div className="icon home"><img src="/style/icons/home.svg"/></div>Home</a>
				...
				<a id="Video" className="menu-item" onClick={this.props.video}><div className="icon video"><img src="/style/icons/video.svg"/></div>Video</a>
